...
// in flower_app/test/config/products/data/repositories/products_repo_impl_test.dart.
...
class MockProductsRemoteDataSource extends _i1.Mock
  ...
  @override
  _i3.Future<_i4.Result<_i5.ProductsResponse>> getProducts({
    required _i6.ProductQueryParams? params,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#getProducts, [], {#params: params}),
            returnValue: _i3.Future<_i4.Result<_i5.ProductsResponse>>.value(
              _i7.dummyValue<_i4.Result<_i5.ProductsResponse>>(
                this,
                Invocation.method(#getProducts, [], {#params: params}),
              ),
            ),
          )
          as _i3.Future<_i4.Result<_i5.ProductsResponse>>);
}
