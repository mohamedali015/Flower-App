...
import 'package:flower_app/config/user_address/data/repositories/user_address_repo_imp.dart';
import 'package:flower_app/config/user_address/domain/repositories/user_address_repo_contract.dart';
  ...
  group("test repo on calling addAddress", () {
    test(
      ...
      () async {
        ...
        when(mockRemoteDataSource.addUserAddress(addAddress)).thenAnswer((
          _,
        ) async {
        ...
        //Act
        var response = await repo.addUserAddress(addAddress);
        //Assert
        ...
        verify(mockRemoteDataSource.addUserAddress(addAddress)).called(1);
      },
    );
    ...
    test(
      ...
      () async {
        //arrange
        when(
          mockRemoteDataSource.addUserAddress(addAddress),
